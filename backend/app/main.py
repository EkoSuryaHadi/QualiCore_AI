...
from .api import assurance, audit, auth, copilot, dashboard, documents, evidence, identity, inspections, ncrs, notifications, projects, punch, reports, risks, users, vendors
...
for router in (
    ...
    assurance.router, copilot.router, identity.router,
):
